...
from difficulty.metrics import  double_model_score, model_complexity_score, prediction_uncertainty_score
from  difficulty.processing import preprocessor
...
double_model_score(file_name, df, max_eval_a, max_eval_b, target_column)


# CDpu
hyper_file_name = "CDpu_hyperparam_binary.xlsx"
processing = preprocessor(cat_columns, num_columns)
prediction_uncertainty_score(hyper_file_name, df, processing, target_column)
...
processing = preprocessor(cat_columns, num_columns)
if __name__ == "__main__":
    model_complexity_score(file_name, df, processing, target_column, number_of_NNs)
